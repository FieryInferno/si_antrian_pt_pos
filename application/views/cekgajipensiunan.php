    ...
    <section class="blog_area" style="padding-top:25px;padding-bottom:25px;">
        <div class="container">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <input name="gaji" class="form-control" type="text" placeholder="" readonly>
                </div>
                <label class="control-label col-xs-3">Tanggal</label>
                <div class="form-group">
                    <input name="tanggal" class="form-control" type="text" placeholder="" readonly>
                </div>
                <label class="control-label col-xs-3">Deskripsi</label>
                <div class="form-group">
                    <textarea name="deskripsi" class="form-control" type="text" placeholder="" readonly></textarea>
                </div>
                <!-- <img id="banner" src="" /> -->
            </form>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#nip').on('input', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('home/getgajipensiunan') ?>",
                    dataType: "JSON",
                    data: {
                        nip: nip
                    },
                    ...
                    success: function(data) {
                        $.each(data, function(nip, nama, judul, gaji, perihal, tanggal, deskripsi) {
