            ...
            <div class="col-lg-4 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('operator/password/index/' . $user->id_user); ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Nama Lengkap -->
                        ...
                        <form action="<?php echo site_url('operator/user/edit_profile/' . $user->id_user); ?>" method="post" class="form-valide" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Jabatan</label>
                                        <select class="form-control" id="jabatan" readonly name="jabatan">
