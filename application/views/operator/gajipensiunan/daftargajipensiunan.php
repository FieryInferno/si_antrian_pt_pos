  ...
  <div class="row page-titles mx-0">
    <div class="col p-md-0">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Daftar Gaji Pensiunan</a></li>
      </ol>
    </div>
  </div>
  <div class="container-fluid">
        ...
        <div class="card gradient-3">
          <div class="card-body">
            ...
            <div class="d-inline-block">
              <h2 class="text-white"><?php echo $jumlah_gajipensiunan; ?> Buah</h2>
            </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Daftar Gaji Pensiunan <?= $date?></h4>
            <hr>
            <form action="<?php echo site_url('laporan/pdfgajipensiunan'); ?>" method="post" target="_blank">
              <div class="row">
                <div class="col-6">
            ...
            <div class="table-responsive">
              <div class="table-responsive">
                <table class="table table-striped table-bordered" id="table" width="100%" cellspacing="0">
                  <tbody>
                    <?php foreach ($gajipensiunan->result() as $result) : ?>
                      <tr>
                        <td>
                          <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <hr>
                                        <h4 class="">NIP : <?php echo $result->nip; ?></h4>
                                        <hr>
                                        <h4 class="">Nama : <?php echo $result->nama; ?></h4>
                                        <hr>
                                        <h4 class="">Tanggal : <?php
                                                        $tanggaldanwaktu = new DateTime($result->tanggal);
                                        ...
                                        <hr>
                                        <h4>Gaji : <?php echo $result->gaji; ?></h4>
                                        <hr>
                                        <h4><?php echo $result->deskripsi; ?></h4>
                                    </div>
                                    <div class="col-md-4">
                                        <img src="<?php echo base_url('upload/arsip/' . $result->kartutandapensiun) ?>" width="100%" class="rounded">
                                    </div>
                                </div>
                            </div>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu btn-block text-center">
                                <a onclick="deleteConfirm('<?php echo site_url('operator/gajipensiunan/delete/' . $result->idgajipensiunan); ?>')" href="#!" style="font-size: 1.2em;" class="ti-trash">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </td>
...
<script>
  function fun() {
    ...
    location.href="<?php echo base_url('operator/gajipensiunan/index'); ?>/"+tanggal_awal + "/" + tanggal_akhir
  }
