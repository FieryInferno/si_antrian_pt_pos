                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('laporan/pdfpembayaran'); ?>" method="post" target="_blank">
                            <input type="date" class="form-control mydatepicker" onchange="fun(this.value)" id="val6" name="tanggal" value="<?php echo $date; ?>" placeholder="pembayaran">
                            <input type="date" class="form-control mydatepicker" onchange="fun(this.value)" id="val6" name="tanggal" value="<?php echo $date; ?>" placeholder="pembayaran">
                            <hr>
...
<script>
    function fun(a) {
        location.href="<?php echo base_url('operator/pembayaran/index'); ?>/"+a
    }
