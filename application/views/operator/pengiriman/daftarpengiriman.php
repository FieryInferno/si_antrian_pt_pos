  ...
  <div class="row page-titles mx-0">
    <div class="col p-md-0">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Daftar Pengiriman</a></li>
      </ol>
    </div>
  </div>
        ...
        <div class="card gradient-3">
          <div class="card-body">
            ...
            <div class="d-inline-block">
              <h2 class="text-white"><?php echo $jumlah_pengiriman; ?> Buah</h2>
            </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <hr>
            <form action="<?php echo site_url('laporan/pdfpengiriman'); ?>" method="post" target="_blank">
              <div class="row">
                <div class="col-6">
            ...
            <div class="table-responsive">
              <div class="table-responsive">
                <table class="table table-striped table-bordered" id="table" width="100%" cellspacing="0">
                  <tbody>
                    <?php foreach ($pengiriman->result() as $result) : ?>
                      <tr>
                        <td>
                          <div class="card">
                            <div class="card-body">
                              <div class="row">
                                  <div class="col-md-12">
                                      <h2 class="">Nama Barang : <?php echo $result->namabarang; ?></h2>
                                      <hr>
                                      <h4 class="">Jenis: <?php echo $result->jenisbarang; ?></h4>
                                      <hr>
                                      <h4 class="">Berat : <?php echo $result->beratbarang; ?> KG</h4>
                                      <hr>
                                      <h4 class="">Jumlah : <?php echo $result->jumlahbarang; ?></h4>
                                      <hr>
                                      <h4 class="">Biaya : <?php echo $result->biaya; ?></h4>
                                      <hr>
                                      <h4 class="">Tanggal : <?php
                                                              $tanggaldanwaktu = new DateTime($result->tanggalpengiriman);
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <h6>Nama Pengirim : <?php echo $result->namapengirim; ?></h6>
                                  <hr>
                                  <h6>No HP Pengirim : <?php echo $result->nohppengirim; ?></h6>
                                  <hr>
                                </div>
                                <div class="col-md-6">
                                  <h6>Nama Penerima : <?php echo $result->namapenerima; ?></h6>
                                  <hr>
                                  <h6>No HP Penerima : <?php echo $result->nohppenerima; ?></h6>
                                  <hr>
                                  <h6>Kota Penerima : <?php echo $result->kota; ?></h6>
                                  <hr>
                                  <h6>Alamat Penerima : <?php echo $result->alamatpenerima; ?></h6>
                                  <hr>
                                </div>
                              </div>
                            </div>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu btn-block text-center">
                                <a onclick="deleteConfirm('<?php echo site_url('operator/pengiriman/delete/' . $result->idpengiriman); ?>')" href="#!" style="font-size: 1.2em;" class="ti-trash">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </td>
...
<script>
  function fun(a) {
    ...
    location.href="<?php echo base_url('operator/pengiriman/index'); ?>/" + tanggal_awal + "/" + tanggal_akhir
  }
